...
// founder photo used on our-purpose page
export const FOUNDER_IMAGE =
  "/our-purpose/founder.JPG";

export const STATS = [
  { label: "sustainable consulting projects led", 
    value: "+150", 
    icon: "/our-purpose/icons/group.svg" },
  {
    label: "students trained across 50 countries",
    value: "+10.000",
    icon: "/our-purpose/icons/presentation.svg",
  },
  {
    label: "students placed in strategic roles (PEEQ, PEWA)",
    value: "68",
    icon: "/our-purpose/icons/graduation.svg",
  },
  {
    label: "of women among our senior executive team",
    value: "50%",
    icon: "/our-purpose/icons/female.svg",
  },
];

// Strategy consulting page: CAPABILITIES and EXPERTISE, TEAM, and CLIENT_LOGOS
// strategy consulting intro image
export const STRATEGY_INTRO_IMAGE =
  "/strategy-consulting/intro/hero.png";
...
export const EXPERTISE = [
  ...
  img: "/strategy-consulting/expertise/image.png",
  },
  {
    key: "mobility",
    title: "Mobility",
...
export const TEAM = [
  {
    name: "Panji Jusuf Gumilang",
    role: "President of ShARE JBS",
    photo:
      "/strategy-consulting/team/president.JPG",
    linkedin: "https://www.linkedin.com/in/panjijusufgumilang/",
    bio: "Leading ShARE JBS with a vision to empower future leaders through strategic thinking and social impact. Passionate about creating opportunities for students to develop real-world business acumen while making a positive difference in society.",
  },
  {
    name: "Azka Hindami",
    role: "Vice President of ShARE JBS",
    photo:
      "/strategy-consulting/team/vice.JPG",
    linkedin: "https://linkedin.com",
    bio: "Supporting the strategic direction of ShARE JBS and driving operational excellence. Committed to building a strong foundation for sustainable growth and ensuring quality delivery across all programs and initiatives.",
  },
  {
    name: "R.RR.Daniya Salsabilla",
    role: "Chief of Human Capital Officer",
    photo:
      "/strategy-consulting/team/human.JPG",
    linkedin: "https://www.linkedin.com/in/daniyasalsabila/",
    bio: "Focused on developing talent and fostering a culture of continuous learning and growth. Dedicated to creating an environment where team members can thrive, develop their skills, and contribute to meaningful projects.",
  },
  {
    name: "Atqia Ali",
    role: "Chief of Business and growth",
    photo:
      "/strategy-consulting/team/business.JPG",
    linkedin: "https://www.linkedin.com/in/atqia-ali-77a7b02b6/",
    bio: "Driving business development and strategic partnerships to expand ShARE JBS's reach and impact. Passionate about identifying growth opportunities and building sustainable business models that align with our mission.",
  },
  {
    name: "Arsyta Musdalifah",
    role: "Chief of Expertise Network",
    photo:
      "/strategy-consulting/team/network.JPG",
    linkedin: "https://linkedin.com",
    bio: "Building and nurturing a network of industry experts, mentors, and professionals. Dedicated to connecting students with valuable insights and experiences from leading practitioners across various sectors.",
  },
];

export const SUPPORT = [
  "/strategy-consulting/support/logo-jbs.png", 
  "/strategy-consulting/support/hoambes.png"];
